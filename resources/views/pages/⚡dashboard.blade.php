    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div
                ...
                <a class="py-3 px-4 md:px-5 inline-flex justify-between items-center text-sm text-gray-600 dark:text-neutral-300 border-t border-gray-200 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-50 dark:focus:bg-neutral-700 rounded-b-xl"
                    href="#">
                    View reports
