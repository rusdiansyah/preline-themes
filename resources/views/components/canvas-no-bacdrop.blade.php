@props(['title'])
<div wire:ignore.self id="hs-filter"
    class="hs-overlay [--body-scroll:true] [--overlay-backdrop:false] hs-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform h-full max-w-xs w-full z-80 bg-overlay border-e border-overlay-line"
    ...
    <div class="flex justify-between items-center py-3 px-4 border-b border-overlay-header">
        ...
        <button type="button"
            ...
            aria-label="Close" data-hs-overlay="#hs-filter">
