<div class="bg-background">
    <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
        ...
        <div class="max-w-3xl mb-10 lg:mb-14">
            <h2 class="text-foreground font-semibold text-2xl md:text-4xl md:leading-tight">Preline reviews</h2>
            <p class="mt-1 text-muted-foreground-1">With over 30 awards, and achievements, we proudly demonstrate our
        ...
        <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
            <div>
                ...
                <blockquote>
                    <p
                        class="font-medium text-xl text-foreground md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                    ...
                    <footer class="mt-6">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4 md:ms-0">
                                <div class="text-base font-semibold text-foreground">Nicole Grazioso</div>
                                <div class="text-xs text-muted-foreground-1">Director Payments & Risk | Airbnb</div>
                            </div>
                        </div>
                    </footer>
                </blockquote>
