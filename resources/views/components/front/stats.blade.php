            ...
            <div class="p-4 lg:p-8 bg-linear-to-bl from-layer via-background to-background-1 rounded-xl">
                <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                    ...
                    <div
                        ...
                        <svg class="shrink-0 size-6 sm:size-8 text-primary mx-auto" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        ...
                        <div class="flex justify-center items-center -space-x-5">
                            <img class="relative z-2 shrink-0 size-8 rounded-full border-3 border-line-2"
                                ...
                                alt="Avatar">
                            <img class="relative z-1 shrink-0 size-8 rounded-full border-3 border-line-2 -mt-7"
                                ...
                                alt="Avatar">
                            <img class="relative shrink-0 size-8 rounded-full border-3 border-line-2"
