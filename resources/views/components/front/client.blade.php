<div class="relative overflow-hidden pt-4 bg-background">
    <svg class="absolute -bottom-20 start-1/2 w-[1900px] transform -translate-x-1/2" width="2745" height="488"
        ...
        <path
            ...
            class="stroke-black/10 dark:stroke-white/10" stroke="currentColor" />
        <path
    ...
    <div class="relative z-10">
        <div class="max-w-5xl px-4 xl:px-0 mx-auto">
            <div class="mb-4">
                <h2 class="text-muted-foreground-1">Trusted by Open Source, enterprise, and more than 99,000 of you</h2>
            </div>

            <div class="flex justify-between gap-6">
                <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-muted-foreground-1"
                ...
                <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-muted-foreground-1" fill="none"
