<div class="bg-background bg-linear-to-t from-background-1 to-transparent">
    <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
            <h2 class="text-foreground font-semibold text-2xl md:text-4xl md:leading-tight">Success stories</h2>
            <p class="mt-1 text-muted-foreground-1">Global brands see measurable success when they collaborate with us.
                From higher conversion and payment approval rates to faster processing speeds. Discover their stories
                here.</p>
        </div>
        <!-- End Title -->
        ...
        <!-- Card Grid -->
        <div
            class="grid grid-cols-1 lg:grid-cols-3 items-center border border-card-line divide-y lg:divide-y-0 lg:divide-x divide-card-line rounded-xl">
            <!-- Card -->
            <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-card first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none focus:outline-hidden before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-primary/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-primary/10 before:-z-1 before:opacity-0 hover:before:opacity-100 focus:before:opacity-100"
                ...
                <div class="mb-5">
                    ...
                    <div class="mt-5">
                        <p class="font-semibold text-5xl text-foreground">43%</p>
                        <h3 class="mt-5 font-semibold text-xl text-foreground">Enhancement in Customer Engagement</h3>
                        <p class="mt-1 text-muted-foreground-1">With the aim of optimizing customer interactions and
                ...
                <p class="mt-auto">
                    <span
                        class="font-medium text-sm text-primary pb-1 border-b-2 border-line-2 group-hover:border-primary-hover group-focus:border-primary-focus transition focus:outline-hidden">
                        Case study
                    </span>
                </p>
            </a>
            ...
            <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-card first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none focus:outline-hidden before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-primary/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-primary/10 before:-z-1 before:opacity-0 hover:before:opacity-100 focus:before:opacity-100"
                ...
                <div class="mb-5">
                    ...
                    <div class="mt-5">
                        <p class="font-semibold text-5xl text-foreground">20%</p>
                        <h3 class="mt-5 font-semibold text-xl text-foreground">Rise in E-commerce</h3>
                        <p class="mt-1 text-muted-foreground-1">In collaboration with Shopify, Preline embarked&nbsp;on
                            a mission to revolutionize the e-commerce experience for a fictitious fashion brand,
                            'StyleAura'.</p>
                    </div>
                </div>
            ...
            <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-card first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none focus:outline-hidden before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-primary/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-primary/10 before:-z-1 before:opacity-0 hover:before:opacity-100 focus:before:opacity-100"
                ...
                <div class="mb-5">
                    ...
                    <div class="mt-5">
                        <p class="font-semibold text-5xl text-foreground">12%</p>
                        <h3 class="mt-5 font-semibold text-xl text-foreground">Streamlining Development</h3>
                        <p class="mt-1 text-muted-foreground-1">With the goal of accelerating project delivery and
                            enhancing collaboration among development teams, Preline leveraged GitLab's comprehensive
                            suite of tools and Preline's expertise in digital product development.</p>
                    </div>
                </div>
        ...
        <div class="mt-5">
            <!-- Quick Action -->
            <a class="py-1 px-3 group inline-flex items-center gap-x-1.5 bg-layer border border-layer-line text-layer-foreground text-sm rounded-full focus:outline-hidden"
                href="case-study.html">
                <div class="flex items-center -space-x-2">
                    <div class="size-6 flex shrink-0 justify-center items-center bg-layer rounded-full">
                    ...
                    <div class="size-6 flex shrink-0 justify-center items-center bg-layer rounded-full">
                        <svg class="shrink-0 size-3.5" width="33" height="32" viewBox="0 0 33 32" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
