        ...
        <div class="relative flex flex-col h-full max-h-full">
            <div class="px-6 pt-4 flex items-center">
                ...
                <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80"
                   wire:navigate href="{{ route('dashboard') }}" aria-label="Preline">
            ...
            <div
                ...
                <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                    <ul class="flex flex-col space-y-1">
                        <livewire:layouts.menu-link route="dashboard" title="Dashboard"
                        ...
                        <li class="hs-accordion" {{ Route::is('users.*') ? 'active' : '' }} id="projects-accordion">
                            <button type="button"
                                class="{{ Route::is('users.*') ? 'bg-gray-100 dark:bg-neutral-800' : '' }} hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100  dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-neutral-200"
                            ...
                            <div id="projects-accordion-child"
                                class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 {{ Route::is('users.*') ? 'block' : 'hidden' }}"
                                role="region" aria-labelledby="projects-accordion">
                                <ul class="ps-8 pt-1 space-y-1">
                                    <livewire:layouts.menu-link route="users.user" title="Users" />
                                    <livewire:layouts.menu-link route="users.level" title="Level" />
                                </ul>
                            </div>
                        </li>
                        ...
                        <livewire:layouts.menu-link route="settings" title="Settings"
